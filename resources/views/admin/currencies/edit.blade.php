...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('global.currency.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form action="{{ route("admin.currencies.update", [$currency->id]) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                ...
                <input type="text" id="currecny_name" name="name" class="form-control" value="{{ old('name', isset($currency) ? $currency->name : '') }}">
                @if($errors->has('name'))
            ...
            <div class="form-group {{ $errors->has('currency_code') ? 'has-error' : '' }}">
                ...
                <input type="text" id="currency_code" name="code" class="form-control" value="{{ old('code', isset($currency) ? $currency->code : '') }}">
                @if($errors->has('code'))
                    <em class="invalid-feedback">
                        {{ $errors->first('code') }}
                    </em>
            ...
            <div class="form-group {{ $errors->has('symbol') ? 'has-error' : '' }}">
                ...
                <input type="text" id="currency_symbol" name="symbol" class="form-control" value="{{ old('symbol', isset($currency) ? $currency->symbol : '') }}">
